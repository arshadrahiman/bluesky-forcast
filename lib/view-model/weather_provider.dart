...
class WeatherProvider extends ChangeNotifier {
  ...
  var _todayWeather = [];
  double _currentLat = 12.8679966;
  double _currentLong = 74.8426871;
  ...
  WeatherCodeModel getWeatherCode(code) {
  ...
  void changeCurrentCountry(BuildContext context, double lat, double long,
    ...
    Navigator.of(context).pushReplacementNamed(AppNamedRoute.homeRoute);
    await setWeather();
  }
